...
class Train_Evaluation(wx.Panel):
    def __init__(self, parent):
        ...
        self.RfParameters['Criterion'] = wx.ComboBox(self,value='mae', pos=(250, 75), choices=['mae','mse'])
...
class Cross_Validation(wx.Panel):
    def __init__(self, parent):
        ...
        self.RfParameters['Criterion'] = wx.ComboBox(self,value='mae', pos=(250, 125), choices=['mae','mse'])
...
class CV_Feature_Selection(wx.Panel):
    def __init__(self, parent):
        ...
        self.RfParameters['Criterion'] = wx.ComboBox(self,value='mae', pos=(250, 175), choices=['mae','mse'])
